...
export const mockCuttingPlan: CuttingPlan = {
  ...
  preparationSteps: [
    "Lavar o cabelo com shampoo e condicionador adequados.",
    "Desembaraçar completamente o cabelo.",
    "Umedecer o cabelo uniformemente com o borrifador de água."
  ],
  steps: [
  ...
  finishingSteps: [
    "Seque o cabelo com secador e escova redonda para dar volume.",
    "Aplique um sérum ou óleo nas pontas para controlar o frizz.",
    "Estilize como desejado."
  ],
  diagrams: [
    {
  ...
  threeDViews: {
    frontPrompt: "A photorealistic image of a person with a layered bob haircut from the front, studio lighting, preserving original face and background.",
    sidePrompt: "A photorealistic image of a person with a layered bob haircut from the side profile, studio lighting, preserving original face and background.",
    backPrompt: "A photorealistic image of a person with a layered bob haircut from the back, studio lighting, preserving original face and background."
  },
};
