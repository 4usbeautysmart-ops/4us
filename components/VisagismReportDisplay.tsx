...
export const VisagismReportDisplay: React.FC<VisagismReportDisplayProps> = ({ report, clientImage, onReset, imageFilterClass }) => {
  const [activeTab, setActiveTab] = useState<'recommendations' | 'avoid'>('recommendations');
  
  return (
    <div id="visagism-report-display" className="bg-gray-800 rounded-2xl p-6 h-full flex flex-col">
      ...
      <div className="flex-grow overflow-y-auto pr-2 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div id="visagism-analysis-cards" className="lg:col-span-1 space-y-6">
            <div className="w-full aspect-square rounded-lg overflow-hidden shadow-lg bg-gray-900">
                <img src={clientImage} alt="Cliente" className={`w-full h-full object-contain ${imageFilterClass}`} />
            </div>
        ...
        <div id="visagism-recommendations-section" className="lg:col-span-2 space-y-6">
